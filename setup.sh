...
echo "2. Get testnet tokens from: https://faucet.testnet.fhenix.zone/"
echo "3. Deploy the contract: npx hardhat run scripts/deploy.js --network fhenix"
...
echo ""
echo "🔗 Useful links:"
echo "   - Fhenix Testnet: https://testnet.fhenix.zone/"
echo "   - Faucet: https://faucet.testnet.fhenix.zone/"
